...
cat > /etc/nginx/sites-available/unified-ops << 'EOF'
# SitePanda
server {
    listen 80;
...
# Enable site
ln -sf /etc/nginx/sites-available/unified-ops /etc/nginx/sites-enabled/
...
echo "  - http://sitepandaseo.com"
echo "  - http://ducrm.com"
echo "  - http://my.logicinbound.com"
echo ""
